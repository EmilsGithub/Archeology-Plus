...
public class ModBlocks {
    ...
    public static final Block SUSPICIOUS_SOUL_SAND = registerBlock("suspicious_soul_sand", new BrushableBlock(Blocks.SOUL_SAND, SoundEvents.ITEM_BRUSH_BRUSHING_SAND, SoundEvents.ITEM_BRUSH_BRUSHING_SAND_COMPLETE, FabricBlockSettings.copy(Blocks.SOUL_SAND).sounds(BlockSoundGroup.SUSPICIOUS_SAND).pistonBehavior(PistonBehavior.DESTROY)));
    public static final Block SUSPICIOUS_RED_SAND = registerBlock("suspicious_red_sand", new BrushableBlock(Blocks.RED_SAND, SoundEvents.ITEM_BRUSH_BRUSHING_SAND, SoundEvents.ITEM_BRUSH_BRUSHING_SAND_COMPLETE, FabricBlockSettings.copy(Blocks.RED_SAND).sounds(BlockSoundGroup.SUSPICIOUS_SAND).pistonBehavior(PistonBehavior.DESTROY)));
    public static final Block SUSPICIOUS_DIRT = registerBlock("suspicious_dirt", new BrushableBlock(Blocks.DIRT, SoundEvents.ITEM_BRUSH_BRUSHING_GRAVEL, SoundEvents.ITEM_BRUSH_BRUSHING_GRAVEL_COMPLETE, FabricBlockSettings.copy(Blocks.DIRT).sounds(BlockSoundGroup.SUSPICIOUS_GRAVEL).pistonBehavior(PistonBehavior.DESTROY)));
